...
//[target]\\
	const reply = (teks) => {
            XeonBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botnma}`,"body": `i hope you fine`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./XeonMedia/cheemspic.jpg`),"sourceUrl": "https://wa.me/6287769744173"}}}, { quoted: m})
        }
        
        const replay = (teks) => {
            XeonBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botnma}`,"body": ` i hope you fine`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./XeonMedia/cheemspic.jpg`),"sourceUrl": "github.com/rifqikhanif"}}}, { quoted: m})
        }
try {
...
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                    templateMessage: {
                        hydratedTemplate: {
                            ...
                            hydratedFooterText: `Baby-Bot`,
                            hydratedButtons: [{
                                urlButton: {
                                    displayText: 'github',
                                    url: 'github.com/rifqikhanif'
                                }
                            }, {
                            	urlButton: {
                                displayText: 'ping',
...
case 'nocategorymenu': {
  ...
  🏷️ ${prefix}listgc
  🏷️ ${prefix}listonline
  🏷️ ${prefix}report (report bug to owner)
  `
  const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                    templateMessage: {
                        hydratedTemplate: {
...
case 'anonymouschatmenu': {
  ...
  🏷️ ${prefix}start ( Start Chat )
  🏷️ ${prefix}next ( Next user )
  🏷️ ${prefix}stop ( stop Anonymous chat )
	`
	  const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                    templateMessage: {
                        hydratedTemplate: {
...
break
case 'sipp': 
reply(`sipp semoga harimu menyenangkan 🙌`)
break
            default:
                if (budy.startsWith('=>')) {
